import{j as e}from"./index-0jnznar-.js";const i=({onClick:r,isSpeaking:t,size:o="md",className:n=""})=>{const a={sm:"w-8 h-8",md:"w-10 h-10",lg:"w-12 h-12"},s={sm:"w-4 h-4",md:"w-5 h-5",lg:"w-6 h-6"};return e.jsx("button",{onClick:r,className:`
        ${a[o]}
